 ...
 for iSat in range(len(satellite)):
  ...
  while DT != endDt:
     ...
     try:
         ...
         dataFrames={}
         os.chdir('/Users/loisks/Desktop/liemohn10/loisks/EMPHEMERIS_'+satellite[iSat])
         f2=glob.glob('rbsp'+satellite[iSat]+'_def_MagEphem_OP77Q_'+date+'*.txt')[0]
         ...
         kyotodf2=pd.DataFrame({'KP':Kp_emphem},index=epoch_ephem)
